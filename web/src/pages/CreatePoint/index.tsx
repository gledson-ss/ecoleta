...
const CreatePoint = () =>{
    ...
    const [selectUf, setSelecUf] = useState('0')
    ...
    // para estado de array ou objeto: manualmente informar o tipo da variavel
    ...
    useEffect(() =>{
        ...
        axios.get<CityResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectUf}/municipios`).then(res =>{
